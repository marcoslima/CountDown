...
var envinfo = {"qx.application":"countdown.Application","qx.debug":false,"qx.debug.databinding":false,"qx.debug.dispose":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"countdown.theme.Theme","qx.version":"1.6"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"countdown":{"resourceUri":"resource","sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:countdown.abaa49f13e85.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="countdown.Application";
...
(function(){var q="center",p="00",o="Dias",n="Horas",m="countdown.Application",l="Segundos",j="interval",h="#ffffff",g="#ffff00",f="#202020",b="top",d="150px bold Arial",c="#000000",a="Minutos";
...
var r=new Date(2013,0,4,18,0);
var v=this.getRoot();
v.setBackgroundColor(c);
var x=new qx.ui.layout.Grid(15,0);
var z=new qx.ui.container.Composite(x);
v.add(z,{edge:0});

for(var i=0;i<4;i++){x.setColumnAlign(i+1,q,b);
}var t=qx.bom.Font.fromString(d);
var w=[];
var u=[o,n,a,l];
var k;
...
for(i=0;i<4;i++){w[k][i]=new qx.ui.basic.Label(p);
w[k][i].set({value:p,rich:false,textAlign:q});
w[k][i].setBackgroundColor(f);
w[k][i].setTextColor(h);
w[k][i].setAlignX(q);
w[k][i].setFont(t);

if(k==0){z.add(w[k][i],{row:0,column:i});
var y=new qx.ui.basic.Label(u[i]);
y.setTextColor(g);
y.setTextAlign(q);
z.add(y,{row:1,column:i});
}}}var s=60;
var B=s*60;
var C=B*24;
var A=0;
var D=new qx.event.Timer(1000);
D.addListener(j,function(e){var F=new Date();
var G=(r.valueOf()-F.valueOf())/1000;
var K=Math.floor(G/C);
G%=C;
var J=Math.floor(G/B);
G%=B;
var E=Math.floor(G/s);
var I=Math.floor(G)%s;
var H=new qx.util.format.NumberFormat();
H.setMinimumIntegerDigits(2);
w[A][0].setValue(H.format(K));
w[A][1].setValue(H.format(J));
w[A][2].setValue(H.format(E));
w[A][3].setValue(H.format(I));
},this);
D.start();
}}});
})();
...
}},properties:{spacingX:{check:h,init:0,apply:p},spacingY:{check:h,init:0,apply:p}},members:{__lN:null,__lL:null,__lM:null,__lO:null,__lP:null,__lQ:null,__lR:null,__lS:null,__lT:null,verifyLayoutProperty:null,__lU:function(){var B=[];
var A=[];
var C=[];
var w=-1;
var v=-1;
...
},_setRowData:function(G,H,I){var J=this.__lL[G];

if(!J){this.__lL[G]={};
this.__lL[G][H]=I;
}else{J[H]=I;
}},_setColumnData:function(K,L,M){var N=this.__lM[K];
...
return this;
},getColumnAlign:function(S){var T=this.__lM[S]||{};
return {vAlign:T.vAlign||q,hAlign:T.hAlign||r};
},setRowAlign:function(U,V,W){this._setRowData(U,o,V);
this._setRowData(U,m,W);
this._applyLayoutChange();
return this;
},getRowAlign:function(X){var Y=this.__lL[X]||{};
return {vAlign:Y.vAlign||q,hAlign:Y.hAlign||r};
},getCellWidget:function(ba,bb){if(this._invalidChildrenCache){this.__lU();
}var ba=this.__lN[ba]||{};
return ba[bb]||null;
},getRowCount:function(){if(this._invalidChildrenCache){this.__lU();
}return this.__lQ+1;
},getColumnCount:function(){if(this._invalidChildrenCache){this.__lU();
}return this.__lR+1;
},getCellAlign:function(bc,bd){var bj=q;
var bh=r;
var bi=this.__lL[bc];
var bf=this.__lM[bd];
var be=this.__lN[bc][bd];
...
for(var i=0,l=this.__lP.length;i<l;i++){var cl=this.__lP[i];
var ch=this.__lV(cl);
...
for(var i=0,l=this.__lO.length;i<l;i++){var ct=this.__lO[i];
var cv=this.__lV(ct);
...
for(var j=0;j<cy.colSpan;j++){cB=cA[cu+j]?cA[cu+j].offset:0;
cs[cu+j].minWidth+=cB;
}}}},_getRowHeights:function(){if(this.__lS!=null){return this.__lS;
}var cP=[];
var cI=this.__lQ;
var cH=this.__lR;
...
for(var cO=0;cO<=cH;cO++){var cG=this.__lN[cQ][cO];
...
if(this.__lP.length>0){this._fixHeightsRowSpan(cP);
}this.__lS=cP;
return cP;
},_getColWidths:function(){if(this.__lT!=null){return this.__lT;
}var cV=[];
var cS=this.__lR;
var cU=this.__lQ;
...
for(var dc=0;dc<=cU;dc++){var cR=this.__lN[dc][db];
...
if(this.__lO.length>0){this._fixWidthsColSpan(cV);
}this.__lT=cV;
return cV;
...
},renderLayout:function(ds,dt){if(this._invalidChildrenCache){this.__lU();
...
for(var dC=0;dC<=du;dC++){var dJ=this.__lN[dC][dP];
if(!dJ){top+=dV[dC]+dB;
continue;
...
return eb;
}},destruct:function(){this.__lN=this.__lL=this.__lM=this.__lO=this.__lP=this.__lT=this.__lS=null;
}});
})();
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__kL=new qx.ui.decoration.css3.BorderImage();

if(p){this.__kM(p);
}}else{this.__kL=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__kL.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__kL:null,getMarkup:function(){return this.__kL.getMarkup();
},resize:function(r,s,t){this.__kL.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__kL.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__kL[y](w);
},_applyBaseImage:function(z,A){if(this.__kL instanceof qx.ui.decoration.GridDiv){this.__kL.setBaseImage(z);
}else{this.__kM(z);
}},__kM:function(B){var G,H,J,I;
this.__kL.setBorderImage(B);
...
this.__kL.setSlice([N,D,E,O]);
}},destruct:function(){this.__kL.dispose();
this.__kL=null;
}});
})();
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__kN:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kN;
},getMarkup:function(){if(this.__kN){return this.__kN;
...
this.__kN=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__kN;
...
}},members:{__kN:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kN;
},getMarkup:function(e){if(this.__kN){return this.__kN;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__kN:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__kN;
},_applyStyle:function(){},getMarkup:function(){if(this.__kN){return this.__kN;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__kS;
this._resizeBorder=this.__kR;
this._styleBorder=this.__kP;
this._generateMarkup=this.__kQ;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__kO:null,__kP:function(D){{var F=qx.theme.manager.Color.getInstance();
...
}},__kQ:function(K){var O=this._generateBackgroundMarkup(K);
...
K[y]=0;
K[p]=0;
return this.__kO=this._generateBackgroundMarkup(K,O);
},__kR:function(S,T,U){var V=this.getInsets();
T-=V.left+V.right;
U-=V.top+V.bottom;
...
},__kS:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
(function(){var a="countdown.theme.Decoration";
...
(function(){var a="countdown.theme.Appearance";
...
(function(){var a="countdown.theme.Color";
...
(function(){var a="countdown.theme.Font";
qx.Theme.define(a,{extend:qx.theme.modern.Font,fonts:{}});
})();
(function(){var a="countdown.theme.Theme";
qx.Theme.define(a,{meta:{color:countdown.theme.Color,decoration:countdown.theme.Decoration,font:countdown.theme.Font,icon:qx.theme.icon.Tango,appearance:countdown.theme.Appearance}});
})();
